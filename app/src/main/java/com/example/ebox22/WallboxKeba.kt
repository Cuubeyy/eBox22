...
class WallboxKeba(_ip:String = "192.168.178.6", _port: Int = 7090) {
    ...
    private fun getMessageReply(messageStr: String, expectKey: String = "", expectValue: Int = -1): String {
        ...
        val future = Executors.newSingleThreadExecutor().submit(callable) //https://stackoverflow.com/questions/56535473/how-to-send-and-receive-strings-through-tcp-connection-using-kotlin
        return future.get()
    }
    ...
    private fun receiveUDP(socket: DatagramSocket): String {
        ...
        try {
            ...
            Log.d(logTag, " packet received: " + buffer)
            Log.d(logTag, " string received: " + buffer.toString(Charsets.ISO_8859_1))
